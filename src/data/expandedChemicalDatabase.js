...
export const expandedChemicalDatabase = {
  ...
  'Phenolphthalein': {
    name: 'Fenolftalein (Asit-Baz İndikatörü)',
    formula: 'C20H14O4',
    molarMass: 318.33,
    ions: null,
    nutrients: { C: 75.5 },
    pKa: 9.3,
    solubility: 0.4,
    category: 'pH İndikatörü'
  },
  'Bromocresol-Green': {
    name: 'Bromkrezol Yeşili (pH İndikatörü)',
  ...
  'Eriochrome-Black-T': {
    name: 'Eriochrome Black T (Kompleksometrik İndikatör)',
    formula: 'C20H12N3NaO7S',
    molarMass: 461.38,
    ions: { 'Na+': 1 },
    nutrients: { N: 9.1, S: 6.9 },
    pKa: 6.3,
    solubility: 10,
    category: 'Kompleksometrik İndikatör'
  },
  'Potassium-Permanganate': {
    ...
    molarMass: 158.03,
    ions: { 'K+': 1, 'MnO4-': 1 },
    nutrients: { K: 24.7, Mn: 34.8 },
    pKa: null,
    solubility: 6.4,
    category: 'Oksitleyici / Dezenfektan'
  },
